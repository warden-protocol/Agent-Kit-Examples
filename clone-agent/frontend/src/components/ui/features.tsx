...
import { CloneMark } from "../../../public/clone-mark"
      ...
      <div className="grid grid-cols-1 gap-12 md:grid-cols-4 md:gap-0">
        ...
        <div className="col-span-2 my-auto px-2">
          ...
          <p className="mt-2 text-3xl font-semibold tracking-tighter text-balance text-gray-900 md:text-4xl">
            Connect & Create Custom Agents
          </p>
          <p className="mt-4 text-balance text-gray-700">
            Link your Discord/Telegram, pick from templates, and customize
            agents through chat or voice.
          </p>
        </div>
            ...
            <div className="relative flex flex-col items-center justify-center">
              <Orbit
                ...
                orbitingObjects={[
                  ...
                  >
                    <RiFlashlightFill className="z-10 size-4 text-gray-900" />
                  ...
                  <div
                    ...
                    className="relative flex items-center justify-center"
                  >
                    <RiP2pLine className="z-10 size-5 text-gray-900" />
                    <div className="absolute size-10 rounded-full bg-white/50 ring-1 shadow-lg ring-black/5"></div>
                    <div className="absolute -top-5 left-4">
                      <div className="flex gap-1">
                  ...
                  <div
                    ...
                    className="relative flex items-center justify-center"
                  >
                    <RiRocket2Fill className="z-10 size-5 text-gray-900" />
                    <div className="absolute size-10 rounded-full bg-white/50 ring-1 shadow-lg ring-black/5"></div>
                    <div
                      style={{
                        animationDelay: "2s",
                  ...
                  <div
                    ...
                    className="relative flex items-center justify-center"
                  >
                    <RiRobot2Fill className="z-10 size-5 text-gray-900" />
                    <div className="absolute size-10 rounded-full bg-white/50 ring-1 shadow-lg ring-black/5"></div>
                    <div className="absolute -top-5 left-4">
                      <div className="flex gap-1">
                  ...
                  <div
                    ...
                    className="relative flex items-center justify-center"
                  >
                    <RiStockFill className="z-10 size-5 text-gray-900" />
                    <div className="absolute size-10 rounded-full bg-white/50 ring-1 shadow-lg ring-black/5"></div>
                    <div
                      style={{
                        animationDelay: "3s",
          ...
          <div className="relative h-[432px] w-[432px]">
            ...
            <div className="pointer-events-none relative h-full select-none">
              ...
              <div className="absolute top-[288px] left-[144px]">
                <div className="relative">
                  <div className="absolute inset-0 size-12 animate-pulse bg-orange-200 blur-[3px]"></div>
                  <div className="relative flex h-12 w-12 flex-col items-center justify-center bg-white ring-1 shadow-sm ring-black/15">
                    <span className="text-sm font-medium text-gray-500">
                    🕹️
                    </span>
                  </div>
        ...
        <div className="col-span-2 my-auto px-2">
          ...
          <p className="mt-4 text-balance text-gray-700">
            Deploy pre-configured agents for trading, community management, and
            analytics with one click.
          </p>
        </div>
        <div className="relative col-span-2 flex items-center justify-center overflow-hidden">
