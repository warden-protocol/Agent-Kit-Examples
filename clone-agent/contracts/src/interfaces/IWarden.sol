...
interface IWarden {
    ...
    function allKeys(
        ...
        external
        view
        returns (KeyResponse[] memory keys, Types.PageResponse memory pageResponse);
    ...
    function keyRequests(
        ...
        external
        view
        returns (KeyRequest[] memory keyRequests, Types.PageResponse memory pageResponse);
    ...
    /// @return pageResponse  pagination details
    function keychains(Types.PageRequest calldata pageRequest)
        external
        view
        returns (Keychain[] memory keychains, Types.PageResponse memory pageResponse);
    ...
    function signRequests(
        ...
        external
        view
        returns (SignRequest[] memory signRequests, Types.PageResponse memory pageResponse);
    ...
    /// @return pageResponse  pagination details
    function spaces(Types.PageRequest calldata pageRequest)
        external
        view
        returns (Space[] memory spaces, Types.PageResponse memory pageResponse);
