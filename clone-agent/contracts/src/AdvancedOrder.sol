...
import { GetPriceResponse, ISlinky, ISLINKY_PRECOMPILE_ADDRESS } from "../src/interfaces/ISlinky.sol";
import { FutureByIdResponse, IAsync, IASYNC_PRECOMPILE_ADDRESS } from "../src/interfaces/IAsync.sol";
